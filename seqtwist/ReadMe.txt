========================================================================
    DYNAMIC LINK LIBRARY: seqtwist-Projektübersicht
========================================================================

Diese seqtwist-DLL wurde vom Anwendungs-Assistenten für 
Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, 
aus denen Ihre seqtwist-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    ...
    (PCH-Datei) mit dem Namen "seqtwist.pch und eine 
